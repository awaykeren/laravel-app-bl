...
<table class="table table-striped" id="tabeldata" width="100%">
	<thead> <tr>
			...
			<th>Alamat</th> <th>Foto</th><th>Action</th> </tr>
	</thead> <tbody>
	@foreach($mahasiswa as $data)
		<tr>
			...
			<td><a href="{{route('mahasiswa.show',$data['id'])}}">Detail</a> | <a href="{{route('mahasiswa.edit',$data['id'])}}">Ubah</a> | <form method="POST" action="{{ route('mahasiswa.destroy', $data->id) }}" onsubmit="return hapus();">
                    @csrf 
